...
from unetr_pp.training.dataloading.dataset_loading import (
    load_dataset,
    DataLoader3D,
    DataLoader2D,
    unpack_dataset,
...
from unetr_pp.training.network_training.network_trainer_synapse import (
    NetworkTrainer_synapse,
)
...
class Trainer_synapse(NetworkTrainer_synapse):
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class(
            [join(unetr_pp.__path__[0], "preprocessing")],
            preprocessor_name,
            current_module="unetr_pp.preprocessing",
        )
        assert preprocessor_class is not None, (
            "Could not find preprocessor %s in unetr_pp.preprocessing"
            % preprocessor_name
        )
